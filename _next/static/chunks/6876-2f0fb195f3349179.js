! function() {
    try {
        var t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            e = Error().stack;
        e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "580b9512-1a3f-42ef-8d64-72c24022e8d3", t._sentryDebugIdIdentifier = "sentry-dbid-580b9512-1a3f-42ef-8d64-72c24022e8d3")
    } catch (t) {}
}(), (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [6876], {
        36876: function(t, e, r) {
            var o = r(14450),
                n = r(49381),
                i = function(t, e) {
                    var r = new o((e = e || {}).typeNumber || -1, e.errorCorrectLevel || n.H);
        ...
        14450: function(t, e, r) {
            ...
            h.addData = function(t) {
                ...
                for (var r = this.errorCorrectLevel << 3 | e, o = s.getBCHTypeInfo(r), n = 0; n < 15; n++) {
                    var i = !t && (o >> n & 1) == 1;
                    ...
                    for (6 == a && a--;;) {
                        for (var u = 0; u < 2; u++)
                            if (null == this.modules[o][a - u]) {
                                var h = !1;
                                i < t.length && (h = (t[i] >>> n & 1) == 1), s.getMask(e, o, a - u) && (h = !h), this.modules[o][a - u] = h, -1 == --n && (i++, n = 7)
                            }
                ...
                for (var o = n.getRSBlocks(t, e), a = new i, h = 0; h < r.length; h++) {
                    var f = r[h];
                    a.put(f.mode, 4), a.put(f.getLength(), s.getLengthInBits(f.mode, t)), f.write(a)
                }
                ...
                for (; !(a.getLengthInBits() >= 8 * l) && (a.put(u.PAD0, 8), !(a.getLengthInBits() >= 8 * l));) a.put(u.PAD1, 8);
                return u.createBytes(a, o)
            }, u.createBytes = function(t, e) {
                for (var r = 0, o = 0, n = 0, i = Array(e.length), u = Array(e.length), h = 0; h < e.length; h++) {
                    var f = e[h].dataCount,
                        l = e[h].totalCount - f;
                    o = Math.max(o, f), n = Math.max(n, l), i[h] = Array(f);
                    for (var g = 0; g < i[h].length; g++) i[h][g] = 255 & t.buffer[g + r];
                    r += f;
                    var d = s.getErrorCorrectPolynomial(l),
                        c = new a(i[h], d.getLength() - 1).mod(d);
                    u[h] = Array(d.getLength() - 1);
                    for (var g = 0; g < u[h].length; g++) {
                        var m = g + c.getLength() - u[h].length;
                        u[h][g] = m >= 0 ? c.get(m) : 0
                    }
                }
                for (var v = 0, g = 0; g < e.length; g++) v += e[g].totalCount;
                for (var E = Array(v), p = 0, g = 0; g < o; g++)
                    for (var h = 0; h < e.length; h++) g < i[h].length && (E[p++] = i[h][g]);
                for (var g = 0; g < n; g++)
                    for (var h = 0; h < e.length; h++) g < u[h].length && (E[p++] = u[h][g]);
                return E
            }, t.exports = u
        },
        17611: function(t, e, r) {
            ...
            n.RS_BLOCK_TABLE = [
                ...
                for (var o = r.length / 3, i = [], s = 0; s < o; s++)
                    for (var a = r[3 * s + 0], u = r[3 * s + 1], h = r[3 * s + 2], f = 0; f < a; f++) i.push(new n(u, h));
                return i
                        ...
                        for (var e = t.getModuleCount(), r = 0, o = 0; o < e; o++)
                            for (var n = 0; n < e; n++) {
                                for (var i = 0, s = t.isDark(o, n), a = -1; a <= 1; a++)
                                    if (!(o + a < 0) && !(e <= o + a))
                                        for (var u = -1; u <= 1; u++) !(n + u < 0) && !(e <= n + u) && (0 != a || 0 != u) && s == t.isDark(o + a, n + u) && i++;
                                i > 5 && (r += 3 + i - 5)
                            }
                        for (var o = 0; o < e - 1; o++)
                            for (var n = 0; n < e - 1; n++) {
...
//# sourceMappingURL=6876-2f0fb195f3349179.js.map